...
struct PreviewModels {
    ...
    static let masterCard = CardModel(id: UUID().uuidString, cardPan: Credentials.masterCard, cardHolder: "Tonny Monthana", expirationDate: "13/24", currency: .usd, bankName: "AMERIABANK", defaultCard: true, cardStyle: .blueGreen, cardType: .masterCard)
    static let visaCard = CardModel(id: UUID().uuidString, cardPan: Credentials.visaCard, cardHolder: "Tonny Monthana", expirationDate: "13/24", currency: .amd, bankName: "INECOBANK", defaultCard: false, cardStyle: .blue, cardType: .visa)
    
    static let mirCard = CardModel(id: UUID().uuidString, cardPan: Credentials.mirCard, cardHolder: "Tonny Monthana", expirationDate: "13/24", currency: .rub, bankName: "SBERBANK", defaultCard: false, cardStyle: .green, cardType: .mir)
    
    static let amexCard = CardModel(id: UUID().uuidString, cardPan: Credentials.amexCard, cardHolder: "Tonny Monthana", expirationDate: "13/24", currency: .usd, bankName: "ACBA", defaultCard: false, cardStyle: .greenBlue, cardType: .amex)

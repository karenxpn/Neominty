...
struct PreviewModels {
    ...
    static let notifications = [NotificationModel(id: UUID().uuidString,
                                ...
                                NotificationModel(id: UUID().uuidString,
                                                  ...
                                                  read: false,
                                                  createdAt: Date(), type: .unknown("some unknown")),]
}

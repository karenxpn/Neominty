...
struct PreviewModels {
    ...
    static let visaCard = CardModel(id: UUID().uuidString, cardPan: Credentials.visaCard, cardHolder: "Tonny Monthana", expirationDate: "13/24", currency: .amd, bankName: "INECOBANK", defaultCard: true, cardStyle: .standardGreen, cardType: .visa, createdAt: Timestamp(date:Date(timeIntervalSinceNow: -1000).toGlobalTime()), bindingId: "binding2")
    ...
    static let amexCard = CardModel(id: UUID().uuidString, cardPan: Credentials.amexCard, cardHolder: "Tonny Monthana", expirationDate: "13/24", currency: .usd, bankName: "ACBA", defaultCard: true, cardStyle: .standardGreenBlue, cardType: .amex, createdAt: Timestamp(date:Date(timeIntervalSinceNow: -1000).toGlobalTime()), bindingId: "binding4")
    ...
    static let userInfo = UserInfoViewModel(model: UserInfo(id: UUID().uuidString, avatar: nil, name: "Karen Mirakyan", email: nil, phone_number: "+37493936313", isVerified: true))

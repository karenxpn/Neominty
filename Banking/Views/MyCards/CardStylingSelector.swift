    ...
    var body: some View {
        ...
        Button {
            ...
            ZStack {
                Circle()
                    .trim(from: 0.5, to: 1)
                    .fill((cardDesign == .greenBlue || cardDesign == .green) ? AppColors.green : AppColors.darkBlue )
                    .frame(width: 24, height: 24)
                Circle()
                    .trim(from: 0, to: 0.5)
                    .fill((cardDesign == .greenBlue || cardDesign == .blue) ? AppColors.darkBlue : AppColors.green )
                    .frame(width: 24, height: 24)
